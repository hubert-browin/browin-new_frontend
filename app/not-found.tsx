    ...
    <section className="bg-browin-gray py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="border border-browin-dark/10 bg-browin-white px-6 py-12 text-center shadow-sm md:px-10">
          <p className="text-sm font-semibold uppercase tracking-[0.16em] text-browin-red">404</p>
          <h1 className="mt-3 text-3xl font-bold uppercase tracking-tight text-browin-dark md:text-4xl">
          ...
          <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Link
              className="border border-browin-dark/10 px-5 py-3 text-sm font-semibold uppercase tracking-[0.16em] text-browin-dark transition-colors hover:border-browin-red hover:text-browin-red"
              href="/produkty"
            >
              Otwórz katalog
            </Link>
