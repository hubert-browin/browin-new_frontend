    ...
    <div className="info-page bg-browin-gray">
      ...
      <header className="border-b border-browin-dark/10 bg-browin-white">
        <div className="container mx-auto px-4 py-10 lg:py-14">
          ...
          <h1 className="mt-4 max-w-3xl text-[2rem] font-bold leading-[1.08] tracking-tight text-browin-dark lg:text-[2.6rem]">
            {page.title}
          </h1>
        ...
        <div className="grid gap-10 xl:grid-cols-[260px_minmax(0,1fr)] xl:gap-12">
          <aside className="xl:sticky xl:top-24 xl:self-start">
            <details
              ...
              open
            >
              <summary className="flex cursor-pointer list-none items-center justify-between gap-2 border-b border-transparent px-4 py-3 text-[10px] font-semibold uppercase tracking-[0.16em] text-browin-dark/55 xl:cursor-default xl:border-browin-dark/10">
                Spis treści
                <CaretRight
          ...
          <article className="max-w-3xl">
            <div className="divide-y divide-browin-dark/10 border border-browin-dark/10 bg-browin-white">
              {page.sections.map((section) => (
                ...
                >
                  <h2
                    className="text-[1.35rem] font-bold tracking-tight text-browin-dark lg:text-[1.5rem]"
